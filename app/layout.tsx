        ...
        <div className="flex min-h-screen bg-slate-50 text-left">
          ...
          <aside className="w-64 bg-[#0F172A] text-white hidden md:flex flex-col fixed h-full z-20 shadow-2xl">
            ...
            <nav className="flex-1 p-4 mt-4 space-y-2">
              ...
              {/* TEDARİKÇİLER (ARTIK AKTİF) */}
              <Link href="/suppliers" className="flex items-center gap-3 p-4 hover:bg-blue-600/20 hover:text-blue-400 rounded-2xl transition-all duration-300 group">
                <Users size={22} className="group-hover:scale-110 transition-transform" /> 
                <span className="font-bold">Tedarikçiler</span>
              </Link>
            </nav>

            <div className="p-6 border-t border-slate-800">
               <div className="bg-slate-800/50 p-4 rounded-2xl text-[10px] text-slate-400 font-mono text-center tracking-widest uppercase">
                 ProcureFlow v1.0.5
               </div>
            </div>
          </aside>
